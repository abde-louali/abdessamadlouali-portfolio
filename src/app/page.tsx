  ...
  return (
    <>
      ...
      <main className="bg-[#121212] min-h-screen text-white selection:bg-white/30 font-sans">
        ...
        {/* Hero / Frames — no id, not linked to any nav */}
        <div>
          <ScrollyCanvas>
        ...
        {/* Work — project showcase, directly under services */}
        <section id="work" className="bg-[#121212] py-24 px-6 border-t border-white/[0.05]">
          <div className="max-w-[1400px] mx-auto">
            <p className="text-[10px] tracking-[0.3em] text-gray-500 uppercase mb-3">Selected Projects</p>
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-white mb-16">My Work</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">

              {/* Laundry Project Card */}
              <Link href="/work/laundry" className="group relative bg-white/[0.03] border border-white/[0.08] rounded-2xl overflow-hidden hover:border-white/20 transition-all duration-500 hover:-translate-y-1">
                ...
                <div className="p-8">
                  <div className="flex items-center gap-2 mb-4">
                    <span className="text-[10px] tracking-[0.2em] text-cyan-400 uppercase">Full Stack</span>
                    <span className="text-gray-600">·</span>
                    <span className="text-[10px] tracking-[0.2em] text-gray-500 uppercase">Spring Boot · React</span>
                  </div>
                  <h3 className="text-xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors duration-300">Laundry Service Platform</h3>
                  <p className="text-gray-400 text-sm leading-relaxed mb-6">End-to-end laundry management with order tracking, delivery logistics, and admin analytics.</p>
              ...
              <div className="bg-white/[0.02] border border-dashed border-white/[0.08] rounded-2xl flex items-center justify-center p-8 min-h-[300px]">
                <div className="text-center">
                  <p className="text-gray-600 text-sm mb-2">More projects</p>
                  <p className="text-gray-700 text-xs">Coming soon</p>
                </div>
              </div>
          ...
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="space-y-6 text-gray-300 text-sm md:text-base leading-relaxed">
                <p>I am a Full Stack Developer and Digital Craftsman with hands-on experience building scalable, high-performance web applications for real-world use cases. I bridge the gap between aesthetic design and robust engineering.</p>
                <p>Strong expertise in React.js, Spring Boot, and Laravel, with hands-on experience designing RESTful APIs, integrating backend services, and solving complex technical challenges including OCR integration with Python.</p>
                <p>Trained at ISTA Ifrane in Full Stack Web Development, delivering end-to-end projects with clean, maintainable code. Solid foundation in Agile/Scrum methodologies and experienced in collaborating closely with product and business stakeholders.</p>
                <p>Currently open to junior full-stack roles with a focus on product-driven teams, long-term growth, and impactful digital experiences.</p>
              </div>
